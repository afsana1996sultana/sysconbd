                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6">
                            <a class="ot-image-box v3 st3" href="{{url('/boardofdirectors')}}">
                                ...
                                <img src="{{url('frontend/images/director.png')}}" alt="Directors">
                            </a>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <a class="ot-image-box v3 st2" href="{{url('/missionvission')}}">
                                ...
                                <img src="{{url('frontend/images/image-box2.jpg')}}" alt="Our Mission & Vision">
                            </a>
                        </div>

                        <div class="col-lg-6 col-md-6">
                            <a class="ot-image-box v3 st1" href="{{url('/ourteam')}}">
                                <div class="overlay">
                                    <h4>Our Team</h4>
                                </div>
                                <img src="{{url('frontend/images/image-box1.jpg')}}" alt="Our Team">
                            </a>
                        </div>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <a class="ot-image-box v3 st4 mb-0" href="{{url('/gallary')}}">
                                ...
                                <img src="{{url('frontend/images/image-box4.jpg')}}" alt="Our Gallery">
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-6 align-self-center">
                    <div class="pabout-left">
                        <img src="{{url('frontend/images/image1-about.png')}}" alt="">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="pabout-right">
                        ...
                        beauty and best of the Automation.</p>
                    </div>
                </div>
            </div>
        </div>
